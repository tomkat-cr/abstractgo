...
# 2025-08-25 | CR
# This script copies the .env.example files to the .env files (as well as other example files to final/modficable files) in the client, server and mcp-server directories.
...
copy_env_example "$BASE_DIR/client/.env.example" "$BASE_DIR/client/.env"
copy_env_example "$BASE_DIR/server/.env.example" "$BASE_DIR/server/.env"
copy_env_example "$BASE_DIR/mcp-server/.env.example" "$BASE_DIR/mcp-server/.env"
